        ...
        >
            ...
            >
                ...
                <div class="card-body p-8">
                    <!-- Date & Meta -->
                    <div
                        class="flex items-center gap-3 text-sm text-base-content/60 mb-3 font-medium"
                    >
                        <span
                            class="bg-base-200 px-3 py-1 rounded-full text-xs uppercase tracking-wide"
                            >Article</span
                        >
                    ...
                    <!-- Title -->
                    <h2
                        class="card-title text-3xl font-bold mb-3 group-hover:text-primary transition-colors leading-tight"
                    >
                        {{ post.title }}
                    </h2>
                    ...
                    <!-- Description -->
                    <p
                        class="text-base-content/70 leading-relaxed line-clamp-3 mb-6"
                    >
                        {{ post.content }}
                    </p>
                </div>
