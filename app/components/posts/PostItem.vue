...
<template>
    ...
    >
        ...
        <div class="flex flex-col justify-center">
            <h3
                class="text-xl font-bold text-base-content mb-2 group-hover/item:text-primary transition-colors"
            >
                {{ post.title }}
            </h3>

            <p
                class="text-base-content/70 text-sm line-clamp-2 mb-3 leading-relaxed"
            >
                {{ post.content }}
            </p>
