...
<template>
  ...
  >
    <div class="container mx-auto flex h-14 items-center justify-between max-w-screen-2xl px-4 md:px-8">
      <!-- Left: Logo -->
      ...
      <div class="hidden md:flex flex-1 justify-center">
        <nav class="flex items-center gap-4 text-sm font-medium">
          <NuxtLink to="/posts" class="transition-colors hover:text-primary text-base-content/60">Posts</NuxtLink>
          <NuxtLink to="/experience" class="transition-colors hover:text-primary text-base-content/60">Experience</NuxtLink>
          <NuxtLink to="/chat" class="transition-colors hover:text-primary text-base-content/60">Chat</NuxtLink>
        </nav>
      </div>
